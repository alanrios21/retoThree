...
import { AppDispatch, loginUser } from '../store/userActions'; // Importa la acción de login
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
          <div className="py-17.5 px-26 text-center">
            <Link className="mb-5.5 inline-block" to="/">
              ...
              <div className="py-1.5 px-26 flex items-center text-center">
                <h2 className=" mr-3 text-center text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  SofTSolutions
                </h2>
                <img className="dark:hidden mt-2" src={LogoDark} alt="Logo" />
              </div>
            </Link>
            <p className="2xl:px-20">
                 At SoftSolutions, we turn challenges into cutting-edge technological solutions to drive our clients' success.
            </p>
            ...
            <form>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  />
                  {errores.email && (
                    <p className="text-red-500 mt-3">{errores.email}</p>
                  )}
                  <span className="absolute right-4 top-4">
                    <svg
                      className="fill-current"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  ...
                  />
                  {errores.password && (
                    <p className="text-red-500 mt-3">{errores.password}</p>
                  )}
                  <span className="absolute right-4 top-4">
                    <svg
                      className="fill-current"
