          ...
          <span className="dark:hidden">
            ...
            >
              <path
                ...
                fill={colorMode === 'dark' ? '#969AA1' : 'white'} // Cambio de color basado en el modo de color
              />
              {/* Otros elementos de tu botón en modo claro */}
            </svg>
          </span>
          <span className="hidden dark:inline-block">
            ...
            >
              <path
                ...
                fill={colorMode === 'dark' ? '#969AA1' : 'white'} // Cambio de color basado en el modo de color
              />
              {/* Otros elementos de tu botón en modo oscuro */}
            </svg>
          </span>
        </span>
      </label>
